...
public static class ArkanoidParityFix
{
    ...
    public static void FixSpriteImporters()
    {
        var paths = new (string path, FilterMode filter)[]
        {
            ...
            ("Assets/Sprites/Backgrounds/bg_pixel_01.png",  FilterMode.Bilinear),
            ("Assets/Sprites/Backgrounds/bg_pixel_02.png",  FilterMode.Bilinear),
            ("Assets/Sprites/Backgrounds/bg_pixel_03.png",  FilterMode.Bilinear),
